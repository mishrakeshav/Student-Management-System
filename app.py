...
add_button = Button(mainframe, text = " Add ",command = add, pady = 10,padx = 40,fg = "#000000", bg = "#ecfbfc",font = ('ariel', 12),activebackground = "#f38181")
...
temp = Label(root,text = "Temperature: {} ".format(get_temperature()) + u"\N{DEGREE SIGN}"+ "C",font = ('ariel', 12), bd = 1,anchor =W)
